...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, defaultTab = 'login' }) => {
  ...
  const handleLogin = async () => {
    if (isPhoneNumber(loginData.emailOrPhone) && !loginData.otp) {
  ...
  const handleRegister = async () => {
    if (isPhoneNumber(registerData.emailOrPhone) && !registerData.otp) {
      alert('Please enter OTP to continue');
      return;
    }
  ...
  const resetForm = () => {
    setLoginData({ emailOrPhone: '', password: '', otp: '' });
    setRegisterData({ name: '', emailOrPhone: '', password: '', otp: '' });
        ...
        <div className="p-6">
          {activeTab === 'login' ? (
            <div className="space-y-4">
              ...
              {isPhoneNumber(loginData.emailOrPhone) && (
                <div>
                  {!otpSent ? (
                    <Button
              ...
              <Button
                ...
                disabled={
                  ...
                  !loginData.password ||
                  (isPhoneNumber(loginData.emailOrPhone) && loginData.otp.length !== 3)
                }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setRegisterData({ ...registerData, emailOrPhone: e.target.value })
                  }
                  className="h-11"
                />
              </div>
              ...
              {isPhoneNumber(registerData.emailOrPhone) && (
                <div>
                  {!otpSent ? (
                    <Button
                      onClick={handleSendOtp}
              ...
              <Button
                ...
                disabled={
                  ...
                  (isPhoneNumber(registerData.emailOrPhone) && registerData.otp.length !== 3)
                }
                className="w-full h-11 bg-primary text-primary-foreground hover:bg-primary/90"
              >
